                ...
                <div class="col-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="custom-validation" method="POST" action="{{('/admin/brands/store/')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label class="form-label" for="brand_name">brand_name</label>
                                    <input type="text" id="brand_name" name="brand_name" class="form-control @error('brand_name') has-error @enderror"  placeholder="name" value="{{ old('brand_name') }}">
                                    @error('brand_name')
